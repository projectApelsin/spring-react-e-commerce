            ...
            <div className="login-form">
                <div className="card">
                    <div className="card-header">
                        <h3 className="text-center">Вход на сайт</h3>
                    </div>
                    <div className="card-body">
                        <form onSubmit={handleSubmit}>
                            <div className="mb-3">
                                <label htmlFor="username" className="form-label">Логин или почта</label>
                                <input
                                    type="text"
                                ...
                                <div id="emailHelp" className="form-text">
                                    <small>Мы никогда не передадим ваш электронный адрес кому-либо еще.</small>
                                </div>
                            </div>
                            <div className="mb-3">
                            ...
                            <div className="mb-3 form-check">
                                ...
                                <label className="form-check-label" htmlFor="exampleCheck1">Запомнить сессию</label>
                            </div>
                            <button type="submit" className="btn btn-success">Войти</button>
                            <a href="/register" className="btn btn-secondary ml-2">Зарегистрироваться</a>
                        </form>
                    </div>
                </div>
            </div>
